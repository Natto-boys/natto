...
const examplePrompts = [
  {
    name: "Lara",
    promptHead: "I'm convinced that",
    text: "I would survive the hunger games"
  },
  {
    name: "Maria",
    promptHead: "Do you agree or disagree that",
    text: "Your mum should not take you on holiday to Napa 🙃"
  },
  {
    name: "Nana",
    promptHead: "A life goal of mine",
    text: "live on a farm"
  },
]
          ...
          <div className="chat chat-end">
            {loading ?
              ...
              <button
                type="submit"
                disabled={isDisabled()}
                className={`mt-6 w-3/8 h-12 inline-flex justify-center items-center transition-all rounded-full px-4 py-1.5 md:py-2 text-base font-semibold leading-7 bg-zinc-200 ring-1 ring-transparent duration-150   ${isDisabled()
